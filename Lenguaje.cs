...
//Requerimiento 5.- Programar la produccion ListaDeCasos -> case Expresion: Bloque de instrucciones | Instruccion (break;)? (ListaDeCasos)?
...
namespace Sintaxis_1
{
    public class Lenguaje : Sintaxis
    {
        ...
        //Switch -> switch (Expresion) {Lista de casos}
        private void Switch()
        {

        }

        //ListaDeCasos -> case Expresion: Bloque de instrucciones | Instruccion (break;)? (ListaDeCasos)?
