namespace Sintaxis_1
{
    ...
    public class Lexico : Token
    {
        ...
        public Lexico()
        {
            ...
            Log.WriteLine("03/05/22 15:31 p.m.");//Requerimiento 1:
        }
        public void cerrar()
        {
            archivo.Close();
        ...
        public void NextToken() 
        {
            ...
            if(estado == E)
            {
                if (getContenido() [0] == '"')
                {
                    Console.WriteLine("Error lexico: No se cerro la cadena con \"");
                    Log.WriteLine("Error lexico: No se cerro la cadena con \"");
                }
                else if (getContenido() [0] == '\'')
                {
                    Console.WriteLine("Error lexico: No se cerro el caracter con '");
                    Log.WriteLine("Error lexico: No se cerro el caracter con '");
                }
                ...
                {
                    Console.WriteLine("Error lexico: No definido");
                    Log.WriteLine("Error lexico: No definido");
                }
            }
            else if (!FinArchivo())
            {
